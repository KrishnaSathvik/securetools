...
describe('Cryptographic Functions', () => {
  ...
  describe('Password Generation', () => {
    ...
    it('calculates entropy for different character sets', () => {
      ...
      expect(lowercaseEntropy).toBeLessThan(alphanumericEntropy)
      expect(alphanumericEntropy).toBeLessThan(fullEntropy)
    })
  })
  ...
  describe('Security Validation', () => {
    ...
    it('validates entropy requirements', () => {
      ...
      expect(highValidation.entropy).toBeGreaterThan(60)
    })
  })
})
